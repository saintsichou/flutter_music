...
class HomeApi {
  static Future<List<Ranks>> getRanksList() async {
    final moveUrl =
        'https://m.music.migu.cn/migu/remoting/cms_list_tag?nid=23603703&pageSize=200&pageNo=0';
  ...
  static Future<List<BannerItem>> getBannerList() async {
    final bannerUrl =
        'https://m.music.migu.cn/migu/remoting/cms_list_tag?pageSize=10&nid=23831003&pageNo=0&type=2006';
